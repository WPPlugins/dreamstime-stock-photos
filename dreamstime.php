...
class Dreamstime
{
  ...
  CONST
    CAPTCHA_SITE_KEY = '6Ld3UQoUAAAAANxv1Tc76Tq31lkLJjVMuNVtQKJW',
    CAPTCHA_SECRET_KEY = '6Ld3UQoUAAAAAL5lUWiIrEbxTyiqS55s0HuaUrwy';
  ...
  {
    check_admin_referer(__FUNCTION__);
  ...
  public function createAccount()
  {
    ...
    try {
      ...
      $this->verifyCapthca($_REQUEST['g-recaptcha-response']);
...
//      throw new Exception($error);
   ...
   * @throws Exception
   */
  public function verifyCapthca($response)
  {
    $result = wp_remote_post('https://www.google.com/recaptcha/api/siteverify', array(
      'body' => array(
